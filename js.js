const cards = [
  ...
  console.log(maindiv) ; 
  function different(thumbnailpic, titlet, header, description) {
    var cardmain = document.createElement("div");
    cardmain.classList.add("gridItem");
    var cardDiv = document.createElement("div");
    cardDiv.classList.add("card");
    var thumbpic = document.createElement("img");
    thumbpic.src = thumbnailpic;
    thumbpic.alt = titlet;
    thumbpic.classList.add("cardImg");
    var titlediv = document.createElement("div");
    titlediv.classList.add("cardContent");
    var titletext = document.createElement("h1");
    titletext.classList.add("cardHeader");
    titletext.innerText = header;
    var desc = document.createElement("p");
    desc.classList.add("cardText");
    desc.innerText = description;
  
    cardDiv.appendChild(thumbpic);
    cardDiv.appendChild(titlediv);
    titlediv.append(titletext, desc);
